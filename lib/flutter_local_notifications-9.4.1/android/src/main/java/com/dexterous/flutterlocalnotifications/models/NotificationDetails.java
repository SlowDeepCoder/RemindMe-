...
public class NotificationDetails implements Serializable {
    ...
    private static final String REPEAT_INTERVAL_LENGTH = "repeatIntervalLength";
    ...
    public static NotificationDetails from(Map<String, Object> arguments) {
        ...
        if (arguments.containsKey(REPEAT_INTERVAL_LENGTH)) {
            notificationDetails.repeatIntervalLength =
                    (Integer) arguments.get(REPEAT_INTERVAL_LENGTH);
        }
